            ...
            <form action="" method="POST">
                <div class="input-group mb-3">
                    <input type="text" class="form-control" id="keyword" name="keyword"
                        placeholder="Temukan nomor atau nama pelanggan" aria-label="Temukan nomor atau nama pelanggan"
                        ...
                        <table class="table table-hover table-bordered" id="sampleTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <center>
                                            <a href="#edit-modal<?= $a['id_pelanggan']; ?>" type="button"><i
                                                    class="fas fa-edit"></i></a>
                                            |
                                            <a href="#modal-delete<?= $a['id_pelanggan']; ?>" type="button"><i
