                ...
                <div class="table-responsive">
                    ...
                    <table class="table" id="tabel_air">
                        ...
                        <tbody>
                            <tr>
                                <td>Rp. 500</td>
                                <td><a href="#edit-modal-air" type="button"><i class="fas fa-edit"></i></a></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                ...
                <div class="table-responsive">
                    ...
                    <table class="table" id="tabel_pma">
                        ...
                        <tbody>
                            <tr>
                                <td>Rp. 500</td>
                                <td><a href="#edit-modal-pma" type="button"><i class="fas fa-edit"></i></a></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                ...
                <div class="table-responsive">
                    ...
                    <table class="table" id="tabel_beban">
                        ...
                        <tbody>
                            <tr>
                                <td>Rp. 1.500</td>
                                <td><a href="#edit-modal-beban" type="button"><i class="fas fa-edit"></i></a></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                    ...
                    <table class="table" id="tabel_rw">
                        ...
                        <tbody>
                            <tr>
                                <td>RW Aman</td>
                                <td>
                                    <a href="#edit-modal-rw" type="button"><i class="fas fa-edit"></i></a>
                                    |
                                    <a href="#modal-delete-rw" type="button"><i class="fas fa-trash-alt"
                                            style="color: red"></i></a>
                                </td>
                            </tr>
                        </tbody>
                    ...
                    <table class="table" id="tabel_desa">
                        ...
                        <tbody>
                            <tr>
                                <td>Pringgasela</td>
                                <td>
                                    <a href="#edit-modal-desa" type="button"><i class="fas fa-edit"></i></a>
                                    |
                                    <a href="#modal-delete-desa" type="button"><i class="fas fa-trash-alt"
                                            style="color: red"></i></a>
                                </td>
                            </tr>
                        </tbody>
                    ...
                    <table class="table" id="tabel_kecamatan">
                        ...
                        <tbody>
                            <tr>
                                <td>Pringgasela</td>
                                <td>
                                    <a href="#edit-modal-kecamatan" type="button"><i class="fas fa-edit"></i></a>
                                    |
                                    <a href="#modal-delete-kecamatan" type="button"><i class="fas fa-trash-alt"
                                            style="color: red"></i></a>
                                </td>
                            </tr>
                        </tbody>
