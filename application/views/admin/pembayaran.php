<main class="app-content">
    ...
    <div class="row mb-2">
        <div class="btn-group">
            <button type="button" class="btn btn-suci dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                Pilih Tahun
            </button>
            ...
            <form action="<?php echo base_url('admin/pembayaran'); ?>" method="POST">
                <div class="input-group mb-3">
                    <input type="text" id="form_search" name="form_search" class="form-control"
                        placeholder="Masukan nomor kartu pelanggan" aria-label="Masukan nomor pelanggan"
