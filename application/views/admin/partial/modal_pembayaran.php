        ...
        <div class="mt-1">
            ...
            <table id="mudak" class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><a id="data"
                                onClick="masuk(this,'<?= $d['id_pelanggan']; ?>','<?= $d['nama_pelanggan']; ?>')"
                                href="javascript:void(0)"><?= $d['id_pelanggan']; ?></a></td>
            ...
            <div class="form-row">
                ...
                <div class="col">
                    <div class="form-group tb-point">
                        ...
                        <input type="text" name="nama_pelanggan" readonly value="" class="form-control"
            ...
            <div class="form-row">
                ...
                <div class="col">
                    <div class="form-group tb-point ml-auto">
                        ...
                        <input type="number" class="form-control qty" id="meter_awal" name="meter_awal">
                    </div>
                </div>
                <div class="col">
                    <div class="form-group tb-point ml-auto">
