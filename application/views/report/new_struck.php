                ...
                <div class="text-center">
                    ...
                    <table class="ml-auto mr-auto">
                        <thead class="text-left">
                            <tr>
                                <th align="left" scope="col">Wilayah</th>
                                <th scope="col">:</th>
                                <th scope="col">[</th>
                                <th scope="col"><?= $a['desa']; ?></th>
                                <th scope="col">]</th>
                                <!-- space -->
                                <th></th>
                                <th></th>
                                ...
                                <th></th>
                                <!-- end space -->
                                <th align="left" scope="col">No. Rek</th>
                                <th scope="col">:</th>
                                <th scope="col">[</th>
                                <th scope="col"><?= $a['id_pelanggan']; ?></th>
                                <th scope="col">]</th>
                            </tr>
                            <tr>
                                <th align="left" scope="col">Jenis Tarif</th>
                                <th scope="col">:</th>
                                <th scope="col">[</th>
                                <th scope="col"><?php if ($a['kategori'] == 'std') {
														echo 'Standar';
                                ...
                                <th></th>
                                <!-- end space -->
                                <th align="left" scope="col">Rek. Bln</th>
                                <th scope="col">:</th>
                                <th scope="col">[</th>
                                <th scope="col"><?= $a['bulan']; ?></th>
                                <th scope="col">]</th>
                            </tr>
                            <tr>
                                ...
                                <th scope="col">:</th>
                                <th scope="col">[</th>
                                <th scope="col"><?= $a['nama_pelanggan']; ?></th>
                                <th scope="col">]</th>
                                <!-- space -->
                                <th></th>
                                <th></th>
                                ...
                                <th></th>
                                <!-- end space -->
                                <th align="left" scope="col">Tanggal Bayar</th>
                                <th scope="col">:</th>
                                <th scope="col">[</th>
                    ...
                    <table class="mb-2 ml-auto mr-auto mt-2">
                        ...
                        <tbody>
                            <tr class="text-center">
                                ...
                                <th style="border: 2px solid #000" scope="col"><?= $a['beban']; ?></th>
                                <th style="border: 2px solid #000" scope="col">500</th>
                                <th style="border: 2px solid #000" scope="col">1.500</th>
                                <th style="border: 2px solid #000" scope="col">500</th>
                                <th style="border: 2px solid #000" scope="col"><?= $a['total_tagihan']; ?></th>
                            </tr>
                            <tr class="">
