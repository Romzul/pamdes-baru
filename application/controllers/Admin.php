...
class Admin extends CI_Controller
{
	...
	public function menu()
	{
		...
		$this->load->view('admin/partial/admin_header');
		$this->load->view('admin/partial/sidebar', $data);
		$this->load->view('admin/partial/modal_delete_desa');
		$this->load->view('admin/partial/modal_delete_kecamatan');
		$this->load->view('admin/partial/modal_delete_rw');
		$this->load->view('admin/partial/modal_edit_air');
		$this->load->view('admin/partial/modal_edit_beban');
		$this->load->view('admin/partial/modal_edit_pma');
		$this->load->view('admin/partial/modal_edit_rw');
		$this->load->view('admin/partial/modal_edit_desa');
		$this->load->view('admin/partial/modal_edit_kecamatan');
		$this->load->view('admin/partial/modal_tambah_rw');
		$this->load->view('admin/partial/modal_tambah_desa');
		$this->load->view('admin/partial/modal_tambah_kecamatan');
